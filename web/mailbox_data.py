...
EMAILS: list[MockEmail] = [
    ...
    MockEmail(
        id="email-015",
        subject="Factuur GLS-2024-01105 — GLS Netherlands",
        sender="facturatie@gls-netherlands.com",
        sender_name="GLS Netherlands B.V.",
        received_at="2026-05-20T09:00:00Z",
        attachment_filename="invoice_013.txt",
        attachment_path=_path("invoice_013.txt"),
        snippet=_snippet("invoice_013.txt"),
        default_tenant="acme",
    ),
    MockEmail(
        id="email-016",
        subject="Factuur DPD-2024-00349 — DPD Netherlands",
        sender="facturatie@dpd.nl",
        sender_name="DPD (Netherlands) B.V.",
        received_at="2026-05-20T09:30:00Z",
        attachment_filename="invoice_014.txt",
        attachment_path=_path("invoice_014.txt"),
        snippet=_snippet("invoice_014.txt"),
        default_tenant="acme",
    ),
    MockEmail(
        id="email-017",
        subject="Factuur UPS-2024-NL-00892 — UPS Nederland",
        sender="billing@ups.nl",
        sender_name="UPS Nederland B.V.",
        received_at="2026-05-20T10:00:00Z",
        attachment_filename="invoice_015.txt",
        attachment_path=_path("invoice_015.txt"),
        snippet=_snippet("invoice_015.txt"),
        default_tenant="acme",
    ),
    MockEmail(
        id="email-014",
